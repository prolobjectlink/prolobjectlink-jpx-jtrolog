...
public final class JTrologExpression extends JTrologTerm implements PrologExpression {

    @Deprecated
    JTrologExpression(PrologProvider provider, PrologTerm left, String operator, PrologTerm right) {
    ...
    @Deprecated
    JTrologExpression(PrologProvider provider, Term left, String functor, Term right) {
	super(EXPRESSION_TYPE, provider, new Struct(functor, new Term[] { left, right }));
    }
	...
	return new JTrologExpression(provider, l, o, r);
    }
