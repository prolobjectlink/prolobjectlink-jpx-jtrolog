...
import io.github.prolobjectlink.prolog.jtrolog.JTrologEngine;
import io.github.prolobjectlink.web.prolog.PrologWebEngine;
import jTrolog.engine.Prolog;

public class JTrologWebEngine extends JTrologEngine implements PrologWebEngine {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JTrologWebEngine other = (JTrologWebEngine) obj;
		if (converter == null) {
